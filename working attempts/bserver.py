...
def players_turn():
    ...
    #         print("Not board have player_position")
    ...
    if isinstance(msg, tiles.MessagePlaceTile):
        if board.set_tile(msg.x, msg.y, msg.tileid, msg.rotation, msg.idnum):
            ...
            send_to_all(tiles.MessagePlayerTurn(idnum))
            board.set_tile(msg.x, msg.y, msg.tileid, msg.rotation, idnum)
            ...
            if idnum in eliminated:
                ...
                # allIdNums.remove(playerTurn)
                # live_idnums.remove(playerTurn)
                playerNum -= 1
                return
        ...
        if not board.have_player_position(msg.idnum):
            ...
            if board.set_player_start_position(msg.idnum, msg.x, msg.y, msg.position):
                send_to_all(tiles.MessagePlayerTurn(idnum))
                board.set_player_start_position(idnum, msg.x, msg.y, msg.position)
